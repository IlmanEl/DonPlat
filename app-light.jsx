...
import { Plus, Users, TrendingUp, Award, Crown, Sparkles, ArrowUpRight, Zap, MessageCircle, Heart } from 'lucide-react';
...
export default function ProjectsLight() {
  ...
  const DonorCard = ({ donor, rank }) => {
    const getBadgeConfig = () => {
      if (donor.badge === 'gold') return {
        color: '#D4AF37',
        gradient: 'linear-gradient(135deg, #F4E4B7 0%, #D4AF37 100%)',
      ...
      if (donor.badge === 'bronze') return {
        color: '#B87333',
        gradient: 'linear-gradient(135deg, #E5C5A8 0%, #B87333 100%)',
  ...
  return (
    <div className="app">
        ...
        <div className="donors-podium">
          ...
          {topDonors[1] && (
            <div className="podium-position second">
              ...
              <div className="podium-avatar" style={{ background: 'linear-gradient(135deg, #E2E8F0 0%, #94A3B8 100%)' }}>
                <span>{topDonors[1].avatar}</span>
                <div className="podium-badge">
                  <Award size={20} strokeWidth={2.5} color="#94A3B8" />
                </div>
              </div>
          ...
          {topDonors[0] && (
            <div className="podium-position first">
              ...
              <div className="podium-avatar" style={{ background: 'linear-gradient(135deg, #F4E4B7 0%, #D4AF37 100%)' }}>
                <span>{topDonors[0].avatar}</span>
                <div className="podium-badge">
                  <Crown size={24} strokeWidth={2.5} color="#D4AF37" />
                </div>
              </div>
          ...
          {topDonors[2] && (
            <div className="podium-position third">
              ...
              <div className="podium-avatar" style={{ background: 'linear-gradient(135deg, #E5C5A8 0%, #B87333 100%)' }}>
                <span>{topDonors[2].avatar}</span>
                <div className="podium-badge">
                  <Award size={20} strokeWidth={2.5} color="#B87333" />
                </div>
              </div>
      ...
      <style jsx>{`
        @import url('https://fonts.googleapis.com/css2?family=Archivo+Black&family=DM+Sans:wght@400;500;600;700;800;900&family=Space+Mono:wght@400;700&display=swap');
        ...
        * {
        ...
        @keyframes urgencyPulse {
          0%, 100% {
            transform: scale(1);
            box-shadow: 0 4px 16px var(--color-shadow-strong), 0 0 0 0 rgba(212, 175, 55, 0.4);
          }
          50% {
            transform: scale(1.05);
            box-shadow: 0 4px 16px var(--color-shadow-strong), 0 0 0 8px rgba(212, 175, 55, 0);
          }
        }
        ...
        .podium-avatar {
          ...
          box-shadow:
            ...
            0 0 0 5.5px var(--color-border-strong),
            0 8px 24px var(--color-shadow-strong);
        }
        ...
        .podium-position.first .podium-avatar {
          ...
          box-shadow:
            ...
            0 12px 32px var(--color-shadow-strong);
        }
